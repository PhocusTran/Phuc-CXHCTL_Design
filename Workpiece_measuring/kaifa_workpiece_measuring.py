    ...
    if grab_result.GrabSucceeded():
        ...
        if index == 1 and confidence_score >= 50 and not first_detection:
            ...
            if index == 0 and confidence_score >= 50:
                ...
                _, OAxis_thresh = cv2.threshold(OAxis_gray, 200, 255, cv2.THRESH_BINARY_INV)
                ...
                for i, c in enumerate(OAxis_cnts):
                    ...
                    # Tính điểm trung điểm dưới của hình chữ nhật
                    bottom_midpoint = (int(x + w / 2), y + h)

                    # Tính điểm kết thúc của đoạn thẳng
                    end_point = (bottom_midpoint[0], bottom_midpoint[1] - 1000)

                    # Vẽ điểm trung điểm
                    #cv2.circle(img, bottom_midpoint, 5, (255, 0, 0), -1)
                    ...
                    if perpendicular_line_coords is None and not is_perpendicular_line_drawn:
                        perpendicular_line_coords = (bottom_midpoint, end_point)
                ...
                if perpendicular_line_coords is not None:
                    point1, point2 = perpendicular_line_coords
                    cv2.line(img, point1, point2, (255, 0, 255), 2)  # Đường thẳng màu hồng
